// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Functions_feature.cs" company="Microsoft Corporation">
...
I want to have built-in functions in rule expression")]
    ...
    [TestClass]
    public partial class Functions_feature
    {
        [Scenario]
        ...
        [Scenario]
        public void should_be_able_to_call_select()
        {
            IConditionExpression filter = new AllOfExpression()
            {
                AllOf = new IConditionExpression[]
