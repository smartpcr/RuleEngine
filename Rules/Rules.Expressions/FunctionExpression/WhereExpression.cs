...
namespace Rules.Expressions.FunctionExpression
{
    ...
    public class WhereExpression: FunctionExpression
    {
        ...
        public WhereExpression(Expression target, FunctionName funcName, params string[] args) : base(target, funcName, args)
        {
