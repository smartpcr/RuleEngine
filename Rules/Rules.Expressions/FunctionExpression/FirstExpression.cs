// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FirstExpression.cs" company="Microsoft Corporation">
...
namespace Rules.Expressions.FunctionExpression
{
    ...
    public class FirstExpression : FunctionExpression
    {
        ...
        public FirstExpression(Expression target, FunctionName funcName, params string[] args) : base(target, funcName, args)
        {
