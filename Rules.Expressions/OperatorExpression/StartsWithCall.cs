...
namespace Rules.Expressions.OperatorExpression
{
    ...
    public class StartsWithCall : OperatorExpression
    {
        private const string methodName = "StartsWith";

        public StartsWithCall(Expression leftExpression, Expression rightExpression) : base(leftExpression, rightExpression)
        {
